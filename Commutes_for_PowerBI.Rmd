...
dataset$API_Key[1] <- as.character(read.table("C:\\Users\\CLuedtke\\Desktop\\GMaps_API_key.txt")[[1]])
dataset$used_surveygizmo[1] <- "No"
dataset$arrival_date[1] <- "2018-02-20"
```
...
if(dataset$calc_commutes[1] == "Yes"){
  ...
  school_df <- result[[2]]
  start.time <- Sys.time()
  acm_commutes <- commute_procedure(acm_df, school_df)
  end.time <- Sys.time()
  # Write to .csv

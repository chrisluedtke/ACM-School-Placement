...
dataset <- read.csv('media/documents/params.csv')
...
# dataset$commute_factor # Yes/No in PowerBI, converted to 1/0
# dataset$age_factor # hard-coded as 0 below
# dataset$ethnicity_factor
# dataset$gender_factor
# dataset$Spanish_factor # hard-coded as 0 below, remove when firm placements done
# dataset$Tutoring_factor # hard-coded as 0 below
# dataset$Edscore_factor
# dataset$Math_factor# hard-coded as 0 below, remove?
```

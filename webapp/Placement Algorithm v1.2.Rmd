...
output_path <- 'media/documents/outputs/' #TODO update commute script to output here
...
if(score_factors$commute_factor > 0){
  acm_commutes <- read.csv(paste0(output_path, 'Output_Commutes.csv'), check.names=FALSE)

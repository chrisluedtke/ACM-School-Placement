...
dataset$commute_factor <- 0 # Yes/No in PowerB, converted to 1/0
...
# We set absolute directories to allow certainty of processin Power BI implementation. Can set eval=TRUE or eval=FALSE when running in R.

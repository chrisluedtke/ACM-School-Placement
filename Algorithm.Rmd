...
```{r}
# Instead of trying to validate something like underage folk in High schools, we can just make it expensive.  By making it super expensive we can reduce the probability of getting invalid placements. I'm going to use this for high school grads primarily. 

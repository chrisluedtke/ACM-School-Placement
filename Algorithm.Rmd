...
one_placement <- function(acm_enc, school_targets, number_of_iterations = 2000){
  ...
  run_intermediate_annealing_process(starting_placements = team_placements_df, school_df = school_targets, best_placements = team_placements_df, best_score = 142078800000, starting_iteration = 1, number_of_iterations = number_of_iterations, s_curve_amplitude = 4000, s_curve_center = 0, s_curve_width = 3000)
}
